...
date. And the duration is ranging from 2014 to \`
...
- Calculation result : In professor’s collection data, the total weight
  of Professor can be calculated by summing up all the weight. So
  professor’s total collection accounts for 216.26 tons.
...
- Calculation result : The total collection of cigarette butts collected
  by Gwynnda in July of 2021 is accounts for1.63^{4} and it can be
  calculated by
